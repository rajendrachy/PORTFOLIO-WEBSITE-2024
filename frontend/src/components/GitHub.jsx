      ...
      <div className="max-w-6xl mx-auto px-6 text-center">
        ...
        <div className="flex flex-col items-center gap-12 w-full">
          ...
          <div className="flex flex-wrap justify-center gap-6 w-full max-w-4xl">
             ...
             >
               <h3 className="text-3xl font-bold dark:text-white">60+</h3>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <img 
              src="https://img.shields.io/github/followers/rajendrachy?label=Followers&style=for-the-badge&color=8a2be2" 
              alt="Followers" 
              className="h-7 shadow-sm"
            />
            <img 
              src="https://img.shields.io/github/stars/rajendrachy?label=Stars&style=for-the-badge&color=ffd700" 
              alt="Stars" 
              className="h-7 shadow-sm"
            />
          </div>
          ...
          <div className="w-full max-w-4xl overflow-x-auto no-scrollbar py-4 px-2">
            <div className="min-w-[500px] flex justify-center">
              <img
                src="https://streak-stats.demolab.com?user=rajendrachy&theme=tokyonight&hide_border=true&border_radius=15"
                alt="GitHub Streak"
          ...
          <div className="w-full max-w-6xl overflow-x-auto no-scrollbar py-6">
            <div className="min-w-[800px] p-8 glass rounded-3xl border border-gray-200 dark:border-white/10 shadow-lg">
              ...
              <img
                src="https://ghchart.rshah.org/rajendrachy"
